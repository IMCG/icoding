...
bool  ROI_AddImage()
{
	...
	// 【1】读入图像
	Mat srcImage1 = imread("E:\\dota_pa.jpg");
	Mat logoImage = imread("E:\\dota_logo.jpg");
	...
	// 【3】加载掩模（必须是灰度图）
	Mat mask = imread("E:\\dota_logo.jpg", 0);
...
bool  LinearBlending()
{
	...
	srcImage2 = imread("E:\\mogu.jpg");
	srcImage3 = imread("E:\\rain.jpg");
...
bool  ROI_LinearBlending()
{
	...
	//【1】读取图像
	Mat srcImage4 = imread("E:\\dota_pa.jpg", 1);
	Mat logoImage = imread("E:\\dota_logo.jpg");
