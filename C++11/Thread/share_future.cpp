...
int main()
{
	try{
		...
		auto f1 = async(launch::sync, doSomething, '.', f);
		auto f2 = async(launch::sync, doSomething, '+', f);
		auto f3 = async(launch::sync, doSomething, '*', f);
